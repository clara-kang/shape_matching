...
class OptVerts:
    ...
    def addObjective(self):
        ...
        self.m.setObjective(sum(self.diff_x[i] * self.diff_x[i] for i in range(len(self.diff_x))) + \
            sum(self.diff_y[i] * self.diff_y[i] for i in range(len(self.diff_y))), GRB.MINIMIZE)
