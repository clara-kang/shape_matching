...
class OptVerts:
    ...
    def createVars(self):
        ...
        self.ds_x = self.m.addVars(len(pair_rels), lb = -GRB.INFINITY, vtype = GRB.INTEGER, name="ds_x")
        self.ds_y = self.m.addVars(len(pair_rels), lb = -GRB.INFINITY, vtype = GRB.INTEGER, name="ds_y")
